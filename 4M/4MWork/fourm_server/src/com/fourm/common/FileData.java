 ...
 * 数据文件表示
 * 
 * @author zhangtaichao , Mobile Bank System, CSII modified by wangzhe
 *         增加方法猜测时间格式
 *         <p>
 *         created on 2012-3-4
 *         </p>
...
public class FileData {
	...
	public static void main(String[] args) {
		...
		// {"Decimal_Separator","Multi_Headings","X_Columns","Time_Pref","Operator"
		// ,"Date","Time","Channels"};
		String[] ss2 = new String[] { "Samples", "Date", "Time", "Y_Unit_Label", "X_Dimension", "X0", "Delta_X" };
		int i=0;
		for (String s : ss2) {
			System.out.println("public String["+i+"] " + s + ";");
			i=i+1;
		}
//add by zjc
...
//		System.out.println(fd.toString());
	...
	public String toString() {
		return "FileData [" + (province != null ? "province=" + province + ", " : "")
				+ (company != null ? "company=" + company + ", " : "") + (mine != null ? "mine=" + mine + ", " : "")
				+ (room != null ? "room=" + room + ", " : "")
				...
				+ (Decimal_Separator != null ? "Decimal_Separator=" + Decimal_Separator + ", " : "")
				...
				+ (Date1 != null ? "Date1=" + Date1 + ", " : "") + (Time1 != null ? "Time1=" + Time1 + ", " : "")
				...
				+ (Y_Unit_Label != null ? "Y_Unit_Label=" + Arrays.toString(Y_Unit_Label) + ", " : "")
				+ (X_Dimension != null ? "X_Dimension=" + Arrays.toString(X_Dimension) + ", " : "")
